...
def get_sym_dict(f, factor, formula=None):
...
def generate_features(df, elem_prop='oliynyk', drop_duplicates=True):
    ...
    elem_props = pd.read_csv(dirpath + '/data/cbfv/element_properties/'
                             +elem_prop+'.csv')
